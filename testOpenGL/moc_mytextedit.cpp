...
QT_MOC_LITERAL(1, 11, 9), // "sendValue"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3), // "num"
QT_MOC_LITERAL(4, 26, 10), // "setIntText"
QT_MOC_LITERAL(5, 37, 13) // "receiveChange"

    },
    "MyTextEdit\0sendValue\0\0num\0setIntText\0"
    "receiveChange"
};
...
void MyTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setIntText((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->receiveChange(); break;
        default: ;
        }
        ...
        {
            typedef void (MyTextEdit::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTextEdit::sendValue)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyTextEdit::sendValue(int _t1)
{
